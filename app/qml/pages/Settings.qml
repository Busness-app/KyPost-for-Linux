            ...
            Flickable {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        // Three distinct states, deliberately worded apart: an update
                        // exists, we are current, or we do not know. "We do not know"
                        // is the state of every client paired to a server too old to
                        ...
                        // When the check last succeeded. Without it, "This is the
                        // newest released version" is indistinguishable from a check
                        // that has been silently failing for a month -- failures are
                        // dropped rather than surfaced, so this timestamp is the only
                        // evidence the user has that the answer is fresh.
                        Text {
                            textFormat: Text.PlainText
